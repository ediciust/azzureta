...
if (message.content === '<@431128702483431435>') {
  const embed = new Discord.RichEmbed()
  .setTitle('Ben AzzuReta:')
...
client.on("message", msg => {
	const uyarıembed = new Discord.RichEmbed()
      .setColor(0x00AE86)
      .setDescription("<a:sinirligif:502208088141725696>" + msg.author + " AzzuReta reklam koruması aktif, reklam yapmayı bırak evlat! <a:sinirligif:502208088141725696>")
...
client.on('message', async msg => {
    ...
    .setTitle(':x: | İlk olarak sesli bir kanala giriş yapmanız gerek.'));
		...
		if (!permissions.has('SPEAK')) {
			 return msg.channel.sendEmbed(new Discord.RichEmbed()
      .setColor('RANDOM')
      .setTitle(':x: | Şarkı başlatılamıyor. Lütfen mikrofonumu açınız.'));
        }
      ...
      .setTitle(`**✅ | Oynatma Listesi: **${playlist.title}** Kuyruğa Eklendi!**`)
         ...
         .setTitle('AzzuReta | Şarkı Seçimi')
   ...
   .setTitle(`:loud_sound: Şuanki Ses Seviyesi: **${serverQueue.volume}**`)
    ...
    .setColor('RANDOM'));
		  return msg.channel.sendEmbed(new Discord.RichEmbed()
    .setColor('RANDOM')
     .setTitle('AzzuReta | Şarkı Kuyruğu')
...
function play(guild, song) {
  ...
  .setTitle("**AzzuReta | 🎙 Müzik Başladı**",`https://cdn.discordapp.com/avatars/473974675194511361/6bb90de9efe9fb80081b185266bb94a6.png?size=2048`)
